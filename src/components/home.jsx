    ...
    return (
        <div className='w-full h-screen  '>
            ...
            <div className='absolute top-0 w-full h-full flex flex-col justify-center px-4 py-2'>
                ...
                <p className='text-2xl pb-2  text-white '>Welcome to the Land of Beauty, Opportunities and Diversity</p>
                <p className='text-2xl pb-2   text-white'>We make you feel Home away from Home</p>
