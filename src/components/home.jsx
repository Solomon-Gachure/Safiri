...
const Home = () => {
    return (
        <div className='max-w-[1400px] h-screen mx-auto '>
            <img className='top-0 left-0 relative w-full h-full object-cover' src="https://images.unsplash.com/photo-1511282491208-d9b80e3deaee?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTEzfHxtdCUyMGtlbnlhfGVufDB8fDB8fHww&auto=format&fit=crop&w=600&q=60" alt="254" />
